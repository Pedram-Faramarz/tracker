...
# Serve frontend from frontend_built/
ANGULAR_DIST = BASE_DIR / 'frontend_built'
...
# SQLite — Render free tier has ephemeral disk
# Data resets on redeploy — use PostgreSQL add-on for persistence
DATABASES = {
    'default': {
